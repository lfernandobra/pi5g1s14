...
CREATE TABLE IF NOT EXISTS `gaedbdoficial`.`aluno` (
  ...
  PRIMARY KEY (`id_usuario`),
  INDEX `fk_responsavel` (`id_responsavel` ASC),
...
-- -----------------------------------------------------
-- Table `gaedbdoficial`.`turma_disciplina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gaedbdoficial`.`turma_disciplina` (
  `turma_id_turma` INT(11) NOT NULL,
  `disciplina_id_disciplina` INT(11) NOT NULL,
  PRIMARY KEY (`turma_id_turma`, `disciplina_id_disciplina`),
  UNIQUE INDEX `UK_nmusjgacc5h9elnwq04j4624w` (`disciplina_id_disciplina` ASC),
  CONSTRAINT `FK_1iyoa5im7a8480jgtxy0swygc`
    FOREIGN KEY (`turma_id_turma`)
    REFERENCES `gaedbdoficial`.`turma` (`id_turma`),
  CONSTRAINT `FK_nmusjgacc5h9elnwq04j4624w`
    FOREIGN KEY (`disciplina_id_disciplina`)
    REFERENCES `gaedbdoficial`.`disciplina` (`id_disciplina`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
