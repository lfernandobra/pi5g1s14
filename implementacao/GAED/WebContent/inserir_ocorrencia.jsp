    		...
    		<div class="panel panel-default">
				...
				<form  class="form-horizontal" id="ocorrencia" method="post" action="adiciona_ocorrencia.jsp" >
					<fieldset class="fsStyle">  				
			    		...
			    		<div class="form-group">
			      			<label class="col-sm-2 control-label" for="txt_nome">Aluno:</label>
								<div class="col-sm-5"> <select id="sel_bimestre_boletim" name ="aluno" value="${param.IDAluno}" class="form-control">
			    	...
			    	<div class="form-group">
						...
						<div class="col-sm-3"> <input type="text" class="form-control" name="data" onKeyPress="MascaraData(ocorrencia.data);"
			    	...
			    	<div class="form-group">
			     		...
			     		<div class="col-sm-5"><input type="text" class="form-control" name="assunto" value="${param.assunto}" tabindex="1"/> </div> 
			   		</div>
			    
			    	<div class="form-group">
			    	 <form accept-charset="UTF-8" action="" method="POST">
			     		<label class="col-sm-2 control-label" for="txt_senha">Descrição</label>
			       		<textarea class="col-sm-9" id="descricao" name="nova_ocorrencia" placeholder="Digite a ocorrência" rows="10" value="${param.descricao}"></textarea> 
			   		</div>
