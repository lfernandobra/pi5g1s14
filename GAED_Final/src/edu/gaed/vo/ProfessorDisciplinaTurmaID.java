...
public class ProfessorDisciplinaTurmaID implements java.io.Serializable{
	...
	@ManyToOne
	@JoinColumn(name="id_professor", referencedColumnName="id_professor", foreignKey = @ForeignKey(name="fk_prof"))
	...
	@ManyToOne
	@JoinColumn(name="id_turma", referencedColumnName="id_turma", foreignKey = @ForeignKey(name="fk_tur"))
	...
	@ManyToOne
	@JoinColumn(name="id_disciplina", referencedColumnName="id_disciplina", foreignKey = @ForeignKey(name="fk_dis"))
