	...
	<form id="usuario" method="post" action="adiciona_usuario.jsp" >
        ...
        <fieldset id = "usuario_dados">
			...
			<p>
                ...
                <input type="text" id="txt_sexo" name="sexo" value="${usuario.sexo}" tabindex="5"/>
			</p>
			<p>
			...
			<p>               
                ...
                <input type="text" id="txt_cidade" name="cidade" value="${usuario.cidade}" tabindex="10"/><p>
                <label id="lbl_estado" for="txt_estado">Estado:</label>  
                <input type="text" id="txt_estado" name="estado" value="${usuario.estado}" tabindex="11"/><p>
                <label id="lbl_CEP" for="txt_endereco">CEP :</label> 
                <input type="text" id="txt_CEP" name="CEP" value="${usuario.CEP}" tabindex="12"/>
			</p>
			<!-- 
			<p>
				<label id="lbl_cpf" for="txt_cpf">CPF :</label> 
                <input type="text" id="txt_cpf" name="cpf" value="${usuario.cpf}" tabindex="12"
                onKeyPress="MascaraCPF(usuario.cpf);"
                onBlur="ValidaCPF(usuario.cpf);"/>
			</p>
			 -->
			</fieldset>
			<fieldset id = "botoes">
